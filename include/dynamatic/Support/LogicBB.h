...
/// If the source value belongs is the result of an operation that belongs to a
/// logical BB, makes the destination operation part of the same BB and returns
/// true; otherwise return false. If the source value is a block argument, make
/// the destination operation part of the entry BB.
