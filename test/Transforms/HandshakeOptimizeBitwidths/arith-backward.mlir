...
// CHECK-SAME:                            %[[VAL_1:.*]]: none, ...) -> i16 attributes {argNames = ["arg0", "start"], resNames = ["out0"]} {
// CHECK:           %[[VAL_2:.*]] = constant %[[VAL_1]] {value = 4 : i32} : i32
// CHECK:           %[[VAL_3:.*]] = arith.trunci %[[VAL_0]] {bb = 0 : ui32} : i32 to i20
// CHECK:           %[[VAL_4:.*]] = arith.trunci %[[VAL_2]] : i32 to i20
// CHECK:           %[[VAL_5:.*]] = arith.shrsi %[[VAL_3]], %[[VAL_4]] : i20
...
// CHECK:           %[[VAL_3:.*]] = arith.trunci %[[VAL_0]] {bb = 0 : ui32} : i32 to i20
// CHECK:           %[[VAL_4:.*]] = arith.trunci %[[VAL_2]] : i32 to i20
// CHECK:           %[[VAL_5:.*]] = arith.shrui %[[VAL_3]], %[[VAL_4]] : i20
// CHECK:           %[[VAL_6:.*]] = arith.trunci %[[VAL_5]] : i20 to i16
// CHECK:           %[[VAL_7:.*]] = d_return %[[VAL_6]] : i16
// CHECK:           end %[[VAL_7]] : i16
// CHECK:         }
